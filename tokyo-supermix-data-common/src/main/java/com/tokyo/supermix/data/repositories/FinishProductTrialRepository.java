...
public interface FinishProductTrialRepository extends JpaRepository<FinishProductTrial, Long> {
  ...
  List<FinishProductTrial> findByFinishProductTestCodeAndTestParameterIdOrderByUpdatedAtDesc(
  ...
  List<FinishProductTrial> findByFinishProductTestCodeAndTrialNoOrderByCreatedAtDesc(
      String finishProductTestCode, Long trialNo);
