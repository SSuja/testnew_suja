...
public interface TestConfigureRepository
	...
	boolean existsByTestIdAndMaterialSubCategoryIdAndRawMaterialId(Long testId, Long materialSubCategoryId,
			Long rawMaterialId);
	...
	List<TestConfigure> findByMaterialSubCategoryIdAndTestType(Long materialSubCategoryId, MainType testType);
	...
	List<TestConfigure> findByMaterialCategoryIdOrMaterialSubCategoryIdOrRawMaterialId(Long materialCategoryId,
