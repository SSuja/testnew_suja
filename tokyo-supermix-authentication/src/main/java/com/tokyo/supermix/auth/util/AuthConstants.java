package com.tokyo.supermix.auth.util;
...
//for plants
	...
	/*
	 * AuthConstants for Plant validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Designation validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Supplier Category validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Supplier validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Employee validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Pour validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Unit validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Test Type validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Parameter validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Plant Equipment Calibration validation key & Success messages
	 */
	...
	public static final String ADD_EQUIPMENT_PLANT_CALIBRATION_SUCCESS = "Plant Equipment Calibration Added Successfully";
	public static final String EQUIPMENT_PLANT_CALIBRATION_DELETED = "Plant Equipment Calibration Successfully Deleted";
	public static final String UPDATE_EQUIPMENT_PLANT_CALIBRATION_SUCCESS = "Plant Equipment Calibration Updated Successfully";
	/*
	 * AuthConstants for Equation validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Plant Equipment validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Customer validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Material Sub Category validation key & Success messages
	 */
	...
	public static final String ADD_MATERIAL_SUB_CATEGORY_SUCCESS = "Material Subcategory Added Successfully";
	public static final String UPDATE_MATERIAL_SUB_CATEGORY_SUCCESS = "Material Subcategory Updated Successfully";
	public static final String DELETE_MATERIAL_SUB_CATEGORY_SUCCESS = "Material Subcategory Successfully Deleted";
	/*
	 * AuthConstants for Material Category validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Test validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Material State validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Raw Material validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Equipment validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Incoming Sample validation key & Success messages
	 */
	...
	public static final String UPDATE_INCOMING_SAMPLE_SUCCESS = "Incoming Sample Updated Successfully";
	public static final String UPDATE_STATUS_INCOMING_SAMPLE_SUCCESS = "Incoming Sample Status Updated Successfully";
	/*
	 * AuthConstants for Project validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Mix Design validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Process Sample Load validation key & Success messages
	 */
	...
	public static final String PROCESS_SAMPLE_LOAD_DELETED = "Process Sample Load Successfully Deleted";
	public static final String ADD_PROCESS_SAMPLE_LOAD_SUCCESS = "Process Sample Load Added Successfully";
	public static final String UPDATE_PROCESS_SAMPLE_LOAD_SUCCESS = "Process Sample Load Updated Successfully";
	/*
	 * AuthConstants for Test Parameter validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for User validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Process Sample validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Mix Design Proportion validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Concrete Strength Test validation key & Success messages
	 */
	...
	public static final String CONCRETE_STRENGTH_TEST_DELETED = "Concrete Strength Test Successfully Deleted";
	public static final String ADD_CONCRETE_STRENGTH_TEST_SUCCESS = "Concrete Strength Test Added Successfully";
	public static final String UPDATE_CONCRETE_STRENGTH_TEST_SUCCESS = "Concrete Strength Test Updated Successfully";
	/*
	 * AuthConstants for Concrete Test validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Equation Parameter validation key & Success messages
	 */
	...
	public static final String ADD_EQUATION_PARAMETER_SUCCESS = "Equation Parameter Added Successfully";
	public static final String DELETED_EQUATION_PARAMETER = "Equation Parameter Successfully Deleted";
	/*
	 * AuthConstants for Admixture Accepted Value validation key & Success messages
	 */
	...
	public static final String ADMIXTURE_ACCEPTED_VALUE_DELETED = "Admixture Accepted Value Successfully Deleted";
	public static final String ADD_ADMIXTURE_ACCEPTED_VALUE_SUCCESS = "Admixture Accepted Value Added Successfully";
	public static final String UPDATE_ADMIXTURE_ACCEPTED_VALUE_SUCCESS = "Admixture Accepted Value Updated Successfully";
	/*
	 * AuthConstants for Accepted Value validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Material Test validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Material Test Trial validation key & Success messages
	 */
	...
	public static final String MATERIAL_TEST_TRIAL_DELETED = "Material Test Trial Succeessfully Deleted";
	public static final String UPDATE_MATERIAL_TEST_TRIAL_SUCCESS = "Material Test Trial Updated Successfully";
	...
	/*
	 * AuthConstants for Parameter Result validation key & Success messages
	 */
	...
	public static final String PARAMETER_VALUE_ADDED_AND_RESULT_UPDATED = "Parameter Values Added & Result Updated Successfully";
	public static final String PARAMETER_RESULT_DELETED = "Parameter Result Successfully Deleted";
	public static final String UPDATE_PARAMETER_RESULT_SUCCESS = "Parameter Result Updated Successfully";
	public static final String RESULT_SUCCESSFULLY_UPDATED = "Result Updated Successfully";
	/*
	 * AuthConstants for Sieve Test Trial validation key & Success messages
	 */
	...
	public static final String DELETE_SIEVE_TEST_TRIAL_SUCCESS = "Sieve Test Trial Successfully Deleted";
	/*
	 * AuthConstants for Sieve Size validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Sieve Accepted Value validation key & Success messages
	 */
	...
	public static final String DELETE_SIEVE_ACCEPTED_VALUE_SUCCESS = "Sieve Accepted Value Successfully Deleted";
	/*
	 * AuthConstants for Sieve Test validation key & Success messages
	 */
	...
	/*
	 * AuthConstants for Fineness Modulus validation key & Success messages
	 */
	...
	public static final String ADD_FINISH_PRODUCT_SAMPLE_SUCCESS = "Finished Product Sample Added Successfully";
	...
	/*
	 * AuthConstants for Concrete Mixer validation key & Success messages
	 */
  ...
  /*
   * AuthConstants for Cube Test Finding validation key & Success messages
   */
