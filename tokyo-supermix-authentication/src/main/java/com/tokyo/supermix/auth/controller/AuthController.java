...
import com.tokyo.supermix.auth.service.AuthService;
...
//  private EmailService emailService;
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody UserRequestDto userRequestDto) {
    ...
    return new ResponseEntity<>(
        new BasicResponse<>(RestApiResponseStatus.OK, AuthConstants.ADD_USER_SUCCESS), HttpStatus.OK);
  }
...
//        emailService.sendMail(userEmail,AuthConstants.SUBJECT_FORGOT_PASSWORD,AuthConstants.MESSAGE_OF_FORGOT_PASSWORD + token);
        return new ResponseEntity<>(
