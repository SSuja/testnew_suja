...
public final class PermissionConstants {
  // plant
  public static final String VIEW_PLANT = "view_production_unit";
  public static final String CREATE_PLANT = "create_production_unit";
  public static final String EDIT_PLANT = "edit_production_unit";
  public static final String DELETE_PLANT = "delete_production_unit";
  /* equipment */
  ...
  /* delivery cycle */
  public static final String VIEW_POUR = "view_delivery_cycle";
  public static final String CREATE_POUR = "create_delivery_cycle";
  public static final String EDIT_POUR = "edit_delivery_cycle";
  public static final String DELETE_POUR = "delete_delivery_cycle";
  /* supplier category */
  public static final String VIEW_SUPPLIER_CATEGORY = "view_supplier_category";
  ...
  public static final String CREATE_FINISH_PRODUCT_SAMPLE_ISSUE =
      "create_finish_product_sample_issue";
  public static final String EDIT_FINISH_PRODUCT_SAMPLE_ISSUE = "edit_finish_product_sample_issue";
  public static final String DELETE_FINISH_PRODUCT_SAMPLE_ISSUE =
      "delete_finish_product_sample_issue";
  /* plant equipment calibration */
  public static final String VIEW_PLANT_EQUIPMENT_CALIBRATION = "view_plant_equipment_calibration";
  public static final String CREATE_PLANT_EQUIPMENT_CALIBRATION =
      "create_plant_equipment_calibration";
  public static final String EDIT_PLANT_EQUIPMENT_CALIBRATION = "edit_plant_equipment_calibration";
  public static final String DELETE_PLANT_EQUIPMENT_CALIBRATION =
      "delete_plant_equipment_calibration";
  /* Role Permission */
  ...
  public static final String VIEW_USER_PLANT_PERMISSION_BY_USER =
      "view_user_plant_permission_by_user";
  ...
  public static final String DASHBOARD_MATERIAL_COUNT_STATUS =
      "material_status_total_count_dashboard";
  /* test parameter */
