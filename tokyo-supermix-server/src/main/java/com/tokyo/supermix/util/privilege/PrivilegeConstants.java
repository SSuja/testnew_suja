...
public class PrivilegeConstants {
  ...
  public static final String PLANT_ROLES = "plantRoles";
  ...
  public static final String UPDATE_USER_PLANT_PERMISSION_SUCCESS = "Plant Permissions Updated Successfully"; 
