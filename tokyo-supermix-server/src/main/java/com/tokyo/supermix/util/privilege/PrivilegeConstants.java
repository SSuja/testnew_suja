...
public class PrivilegeConstants {
   ...
   */
  public static final String UPDATE_ROLE_PERMISSION_SUCCESS =
  ...
  public static final String UPDATE_PLANT_ACCESS_ROLE_SUCCESS =
      "Successfully Updated plantAccessLevel";
