...
public class Constants {
  ...
  public static final String SUBJECT_MATERIAL_TEST = "Notification : About Material Test Result ";
  public static final String SUBJECT_CONCRETE_TEST = "Notification : About Plant-Lab Trial Sample Result ";
  ...
  /*
   * Constants for Finish Product Accepted Value validation key & Success messages
   */
  public static final String FINISH_PRODUCT_ACCEPTED_VALUE = "finishProductAcceptedValue";
  public static final String FINISH_PRODUCT_ACCEPTED_VALUES = "finishProductAcceptedValues";
  public static final String FINISH_PRODUCT_ACCEPTED_VALUE_ID = "finishProductAcceptedValueId";
  public static final String DELETE_FINISH_PRODUCT_ACCEPTED_VALUE =
      "Finish Product Accepted Value Deleted Successfully";
  public static final String ADD_FINISH_PRODUCT_ACCEPTED_VALUE_SUCCESS =
