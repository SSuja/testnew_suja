...
public class Constants {
	...
	// Success Messages
	public static final String CONCRETE_STRENGTH_TEST_DELETED = "concreteStrengthTest Deleted Succeessfully";
	public static final String ADD_CONCRETE_STRENGTH_TEST_SUCCESS = "concreteStrengthTest added Successfully";
	public static final String UPDATE_CONCRETE_STRENGTH_TEST_SUCCESS = "concreteStrengthTest updated Successfully";
	/*
	 * concreteTest*
	 */
