...
//for EquipmentPlant
	...
	@Value("${validation.euipmentplant.alreadyExist}")
	private String euipmentPlantAlreadyExist;

	@Value("${validation.euipmentplant.notExist}")
	private String euipmentPlantNotExist;

	@Value("${euipmentPlantDto.serialNo.empty}")
	private String euipmentPlantSerialNoIsEmpty;

	@Value("${euipmentPlantDto.serialNo.null}")
	private String euipmentPlantSerialNoIsNull;

	@Value("${euipmentPlantDto.brandName.null}")
	private String euipmentPlantBrandNameIsNull;

	@Value("${euipmentPlantDto.brandName.empty}")
	private String euipmentPlantBrandNameIsEmpty;

	public String getEuipmentPlantSerialNoIsEmpty() {
		return euipmentPlantSerialNoIsEmpty;
	}

	public void setEuipmentPlantSerialNoIsEmpty(String euipmentPlantSerialNoIsEmpty) {
		this.euipmentPlantSerialNoIsEmpty = euipmentPlantSerialNoIsEmpty;
	}

	public String getEuipmentPlantSerialNoIsNull() {
		return euipmentPlantSerialNoIsNull;
	}

	public void setEuipmentPlantSerialNoIsNull(String euipmentPlantSerialNoIsNull) {
		this.euipmentPlantSerialNoIsNull = euipmentPlantSerialNoIsNull;
	}

	public String getEuipmentPlantBrandNameIsNull() {
		return euipmentPlantBrandNameIsNull;
	}

	public void setEuipmentPlantBrandNameIsNull(String euipmentPlantBrandNameIsNull) {
		this.euipmentPlantBrandNameIsNull = euipmentPlantBrandNameIsNull;
	}

	public String getEuipmentPlantBrandNameIsEmpty() {
		return euipmentPlantBrandNameIsEmpty;
	}

	public void setEuipmentPlantBrandNameIsEmpty(String euipmentPlantBrandNameIsEmpty) {
		this.euipmentPlantBrandNameIsEmpty = euipmentPlantBrandNameIsEmpty;
	}

	public String getEuipmentPlantAlreadyExist() {
		return euipmentPlantAlreadyExist;
	}

	public void setEuipmentPlantAlreadyExist(String euipmentPlantAlreadyExist) {
		this.euipmentPlantAlreadyExist = euipmentPlantAlreadyExist;
	}

	public String getEuipmentPlantNotExist() {
		return euipmentPlantNotExist;
	}

	public void setEuipmentPlantNotExist(String euipmentPlantNotExist) {
		this.euipmentPlantNotExist = euipmentPlantNotExist;
	}
