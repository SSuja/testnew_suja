...
public final class EndpointURI {
	...
	public static final String SIEVE_TEST_TRIAL_BY_SIEVE_TEST_CODE = SIEVE_TEST_TRIAL + SLASH + "sieve-test" + SLASH
			+ "{sieveTestCode}";
	public static final String GET_SIEVE_TEST_TRIAL_BY_PLANT = SIEVE_TEST_TRIAL + SLASH + "plant" + SLASH
			+ "{plantCode}";
	...
	public static final String MIX_DESIGN_PARAMETER_RESULT = BASE_API_PATH + "mixdesign-parameter-result";
	public static final String MIX_DESIGN_PARAMETER_RESULTS = BASE_API_PATH + "mixdesign-parameter-results";
	public static final String GET_MIX_DESIGN_PARAMETER_RESULT_BY_ID = MIX_DESIGN_PARAMETER_RESULT + ID;
	public static final String DELETE_MIX_DESIGN_PARAMETER_RESULT_BY_ID = MIX_DESIGN_PARAMETER_RESULT + ID;
