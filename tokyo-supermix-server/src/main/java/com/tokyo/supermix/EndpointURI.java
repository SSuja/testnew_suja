...
public final class EndpointURI {
	...
	public static final String MATERIAL_ACCEPTED_VALUE_BY_TEST_CONFIGURE_ID = MATERIAL_ACCEPTED_VALUE
	...
	public static final String INCOMING_SAMPLE_SUMMARY_REPORT = BASE_API_PATH + SLASH + "incoming-sample-summary-report"
			+ SLASH + "{incomingSampleCode}";
	public static final String INCOMING_SAMPLE_DELIVERY_REPORT = BASE_API_PATH + SLASH
	...
	public static final String SIEVE_TRIALS_BY_MATERIAL_TEST_CODE = BASE_API_PATH + "material-test-sieve" + SLASH
			+ "{materialTestCode}";
	/*
	 * File Export
	 */
	...
	public static final String FINISH_PRODUCT_PARAMETER_RESULT_BY_FINISH_PRODUCT_SAMPLE = FINISH_PRODUCT_PARAMETER_RESULT
			+ SLASH + "finish-product-sample" + SLASH + "{finishProductSampleCode}";
	/*
	 * Finish Product Test
	 */
