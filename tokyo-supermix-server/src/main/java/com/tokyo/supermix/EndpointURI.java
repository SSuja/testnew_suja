...
public final class EndpointURI {
	...
	public static final String GET_SUPPLIER_BY_SUPPLIER_CATEGORY_ID = BASE_API_PATH + "supplier-category" + SLASH
			+ "{suppilerCategoryId}" + SLASH + "plant" + SLASH + "{plantCode}";
	public static final String SUPPLIER_SEARCH = SUPPLIER + SEARCH + SLASH + "{plantCode}";
	public static final String GET_SUPPLIERS_BY_PLANT_CODE = SUPPLIERS + SLASH + "plant" + SLASH + "{plantCode}";
	public static final String SUPPLIER_BY_PLANT = SUPPLIER + PLANT_WISE;
	public static final String GET_SUPPLIERS_BY_PLANT_CODE_AND_SUPPLIER_CATEGORY = SUPPLIERS + SLASH + "plant" + SLASH
			+ "{plantCode}" + SLASH + "supplier-category" + SLASH + "{supplierCategoryId}";
	public static final String GET_SUPPLIER_BY_PLANT_CODE = SUPPLIERS + PLANT_WISE_SEARCH + SLASH + "supplierName";
	...
	public static final String EMPLOYEE_WITH_TOKEN = EMPLOYEE + SLASH + "confirmation" + SLASH + "{confirmationToken}";
	public static final String GET_EMPLOYEES_BY_PLANT = EMPLOYEES + PLANT_WISE_SEARCH + SLASH + "firstName";
	...
	public static final String MATERIAL_CATEGORY_BY_MAIN_TYPE = MATERIAL_CATEGORY + SLASH + "main-type" + SLASH
			+ "{mainType}";
	/*
	 * Pour APIs
	 */
	...
	public static final String GET_TEST_CONFIGURE_BY_TEST_TYPE = TEST_CONFIGURE + SLASH + "test-type" + SLASH
			+ "{testType}";
	...
	public static final String GET_TEST_CONFIGURE_BY_MATERIAL_SUB_CATEGORY = TEST_CONFIGURE + SLASH
			+ "material-sub-category" + SLASH + "{materialSubCategoryId}";
	public static final String GET_TEST_CONFIGURE_BY_MATERIAL_SUB_CATEGORY_AND_TEST_TYPE = TEST_CONFIGURE + SLASH
			+ "material-sub-category" + SLASH + "{testType}" + SLASH + "{materialSubCategoryId}";
	public static final String UPDATE_ACCEPTED_TYPE_TEST_CONFIGURE = TEST_CONFIGURE + SLASH + "{testConfigureId}"
			+ SLASH + "accepted-type" + SLASH + "{acceptedType}";
	public static final String GET_TEST_CONFIGURE_BY_MATERIAL_CATEGORY = TEST_CONFIGURE + SLASH + "material-category"
			+ SLASH + "{materialCategoryId}";
	public static final String TEST_CONFIGURE_PAGINATION = BASE_API_PATH + "test-configure-pagination";
	/*
	 * Material State
	 */
	...
	public static final String ACTIVE_RAW_MATERIALS = BASE_API_PATH + "active" + SLASH + "raw-materials";
	public static final String GET_BY_MATERIAL_SUB_CATEGORY = RAW_MATERIAL + SLASH + "material-sub-category" + SLASH
	...
	public static final String GET_RAW_MATERIALS_BY_PLANT = RAW_MATERIAL + PLANT_WISE_SEARCH + SLASH + "name";
	public static final String GET_RAW_MATERIALS_BY_MAIN_TYPE = RAW_MATERIAL + SLASH + "main-type" + SLASH
			+ "{mainType}";
	/*
	...
	public static final String EQUIPMENT_PLANT_CALIBRATION_SEARCH = EQUIPMENT_PLANT_CALIBRATION + SEARCH + SLASH
			+ "{plantCode}";
	...
	public static final String EQUIPMENT_PLANT_CALIBRATIONS_BY_PLANT = EQUIPMENT_PLANT_CALIBRATION + PLANT_WISE;
	/*
	 * PlantEquipment
	 * 
	 */
	...
	public static final String GET_PLANTEQUIPMENTS_BY_PLANT_CODE = PLANT_EQUIPMENTS + SLASH + "plant" + SLASH
			+ "{plantCode}";
	...
	public static final String GET_CUSTOMERS_BY_PLANT_CODE = CUSTOMERS + PLANT_WISE_SEARCH + SLASH + "customerName";
	public static final String GET_TEST_DETAILS_BY_CONFIGURE_ID = TEST_CONFIGURE + SLASH + "testDetails" + SLASH
			+ "{testConfigId}";
	public static final String CUSTOMER_BY_PLANT = CUSTOMER + PLANT_WISE;
	public static final String PLANT_EQUIPMENTS_BY_CALIBRATION_TRUE_AND_EQUIPMENTID = PLANT_EQUIPMENT + SLASH
			+ "equipment" + SLASH + "{equipmentId}" + SLASH + "{plantCode}";
	/*
	 * Equation APIs
	 */
	...
	public static final String EQUATIONS_BY_EQUATION_TYPE = EQUATION + SLASH + "equation-type" + SLASH
			+ "{equationType}";
	public static final String EQUATION_BY_EQUATION_NAME = EQUATION + SLASH + "equation-name" + SLASH
			+ "{equationName}";
	public static final String EQUATION_BY_EQUATION_EXISTS_TRUE = EQUATION + SLASH + "equation-exists-true";
	public static final String UPADTE_TEST_CONFIGURE_EQUATION = EQUATION + SLASH + "update-equation" + SLASH
			+ "{testConfigureId}";
	/*
	 * Parameter apis
	 * 
	...
	public static final String PARAMETER_BY_PARAMETER_TYPE = PARAMETER + SLASH + "parameter-type" + SLASH
			+ "{parameterType}";
	public static final String PARAMETER_SEARCH = PARAMETER + SEARCH;
	public static final String PARAMETER_SEARCH_BY_TYPE = PARAMETER + SLASH + "parameter-type" + SLASH
	...
	public static final String GET_PROJECTS_BY_CUSTOMER = PROJECTS + SLASH + "customer" + SLASH + "{customerId}";

	public static final String GET_PROJECTS_BY_CUSTOMER_PLANT_WISE = PROJECTS + SLASH + "customer" + SLASH
			+ "{customerId}" + PLANT_WISE;
	public static final String GET_PROJECT_BY_NAME = PROJECTS + PLANT_WISE_SEARCH + SLASH + "projectName";
	/*
	 * IncomingSample Apis
	 */
	...
	public static final String INCOMING_SAMPLES_BY_MATERIAL_SUB_CATEGORY = INCOMING_SAMPLES + SLASH
			+ "material-sub-category" + SLASH + "{materialSubCategoryId}" + SLASH + "plant" + SLASH + "{plantCode}";
	...
	// PLANT_WISE;
	public static final String INCOMING_SAMPLE_BY_PLANT = INCOMING_SAMPLE + SLASH + "sample-type" + SLASH
			+ "{rawMaterialSampleType}" + PLANT_WISE;
	public static final String INCOMING_SAMPLES_BY_PLANT_CODE = INCOMING_SAMPLES + SLASH + "plant" + SLASH
			+ "{plantCode}";
	public static final String GET_INCOMING_SAMPLE_BY_PLANT_CODE = INCOMING_SAMPLES + PLANT_WISE_SEARCH + SLASH
			+ "incoming-sample";
	public static final String GET_INCOMING_SAMPLES_BY_MATERIAL_SUB_CATEGORY = INCOMING_SAMPLES + SLASH
			+ "material-sub-category" + SLASH + "{materialSubCategoryId}" + SLASH + "plant" + SLASH + "{plantCode}"
			+ SLASH + "incoming-sample";
	public static final String INCOMING_SAMPLES_BY_SUPPLIER_ID = INCOMING_SAMPLES + SLASH + "supplier" + SLASH
			+ "{supplierId}";
	public static final String INCOMING_SAMPLES_BY_MATERIAL_CATEGORY = INCOMING_SAMPLES + SLASH + "material-category"
			+ SLASH + "{materialCategoryId}" + SLASH + "plant" + SLASH + "{plantCode}";
	public static final String INCOMING_SAMPLES_BY_RAW_MATERIAL_ID = INCOMING_SAMPLES + SLASH + "raw-material" + SLASH
			+ "{rawMaterialId}";
	public static final String INCOMING_SAMPLES_BY_SAMPLE_TYPE = INCOMING_SAMPLES + SLASH + "plant" + SLASH
			+ "{plantCode}" + SLASH + "sample-type" + SLASH + "{rawMaterialSampleType}";
	/*
	 * Mix design apis
	 * 
	 */
	...
	public static final String GET_MIX_DESIGN_BY_STATUS = MIX_DESIGN + SLASH + "status" + SLASH + "{status}";
	public static final String GET_MIX_DESIGN_BY_MATERIAL_CATEGORY = MIX_DESIGN + SLASH + "material-category" + SLASH
			+ "{materialCategoryId}";
	public static final String GET_MIX_DESIGN_BY_RAW_MATERIAL = MIX_DESIGN + SLASH + "raw-material" + SLASH
			+ "{rawMaterialId}";
	public static final String GET_MIX_DESIGNS_BY_PLANT = MIX_DESIGN + PLANT_WISE_SEARCH + SLASH + "code";
	public static final String GET_MIX_DESIGNS_BY_RAW_MATERIAL_WITH_STATUS = MIX_DESIGN + "search" + SLASH
			+ "{rawMaterialId}" + SLASH + "{status}" + SLASH + "code";
	public static final String MIX_DESIGNS_WITH_TOKEN = MIX_DESIGN + SLASH + "confirmation" + SLASH
			+ "{confirmationToken}";
	...
	public static final String TEST_PARAMETERS_BY_TEST_CONFIGURE_ID = TEST_PARAMETER + "/test-parameters"
			+ "/{testConfigureId}";
	public static final String QUALITY_PARAMETERS_BY_TEST_CONFIGURE_ID = TEST_PARAMETER + "/quality-parameters"
			+ "/{testConfigureId}";
	public static final String TEST_PARAMETER_BY_TEST_CONFIGURE = TEST_PARAMETER + SLASH + "test-configure" + SLASH
			+ "{testConfigureId}";
	...
	public static final String PROCESS_SAMPLE_SEARCH = PROCESS_SAMPLE + SEARCH + SLASH + "{plantCode}";
	public static final String PROCESS_SAMPLE_SEARCH_TYPE = PROCESS_SAMPLES + SEARCH + SLASH + "{plantCode}";
	public static final String PROCESS_SAMPLES_BY_PLANT_CODE = PROCESS_SAMPLES + SLASH + "plant" + SLASH
			+ "{plantCode}";
	...
	public static final String MIX_DESIGN_PROPORTION_BY_ID_DELETE = MIX_DESIGN_PROPORTION + ID + SLASH + "delete"
			+ SLASH + "{mixDesignCode}";
	...
	public static final String GET_PARAMETER_RESULT_BY_PLANT = PARAMETER_RESULT + SLASH + "plant" + SLASH
			+ "{plantCode}";
	public static final String GET_PARAMETER_RESULTS_BY_MATERIAL_TEST_TRIAL_CODE_AND_MATERIAL_TEST_CODE = PARAMETER_RESULT
			+ SLASH + "getParameterResultWithConfigValue" + SLASH + "{materialTestTrialCode}" + SLASH
			+ "{materialTestCode}";
	public static final String PARAMETER_RESULT_BY_MATERIAL_TEST_CODE = PARAMETER_RESULT + SLASH + "matrial-test"
			+ SLASH + "{materialTestCode}";
	public static final String SIEVETEST_PARAMETER_RESULT_BY_MATERIAL_TEST_CODE = PARAMETER_RESULT + SLASH
			+ "matrial-test" + SLASH + "sieve-test" + SLASH + "{materialTestCode}";
	public static final String PARAMETER_RESULT_VIEW_BY_MATERIAL_TEST_CODE = PARAMETER_RESULT + SLASH + "result-view"
			+ SLASH + "{materialTestCode}";
	...
	public static final String MATERIAL_TEST_BY_INCOMING_SAMPLE_CODE = MATERIAL_TEST + SLASH + "incoming-sample" + SLASH
			+ "{incomingSampleCode}" + PLANT_WISE;
	public static final String MATERIAL_TEST_BY_INCOMING_SAMPLE_CODE_AND_TEST = MATERIAL_TEST + SLASH
			+ "incoming-sample" + SLASH + "{incomingSampleCode}" + SLASH + "test" + SLASH + "{testConfigId}"
			+ PLANT_WISE;
	public static final String MATERIAL_TEST_BY_PLANT_CODE = MATERIAL_TEST + SLASH + "incoming-sample" + PLANT_WISE;
	public static final String SEARCH_MATERIAL_TEST = MATERIAL_TEST + SEARCH + SLASH + "{plantCode}";
	public static final String GET_MATERIAL_TEST_BY_PLANT = MATERIAL_TEST + SLASH + "plant" + SLASH + "{plantCode}";
	...
	public static final String MATERIAL_TESTS_BY_TESTCONFIGURE_TESTTYPE = MATERIAL_TESTS + "/test-configure"
			+ "/testType" + SLASH + "{testType}";
	...
	public static final String MATERIAL_TEST_TRIAL_BY_MATERIAL_TEST_CODE = MATERIAL_TEST_TRIAL + "/material-test"
			+ "/{materialTestCode}";
	public static final String MATERIAL_RESULT_BY_MATERIAL_TEST_CODE = MATERIAL_TEST_TRIAL + "/material-test"
			+ "/average" + "/{materialTestCode}";
	public static final String GET_MATERIAL_TEST_TRIAL_BY_PLANT = MATERIAL_TEST_TRIAL + SLASH + "plant" + SLASH
			+ "{plantCode}";
	...
	public static final String FINISH_PRODUCT_SAMPLE_SEARCH = FINISH_PRODUCT_SAMPLE + SEARCH + SLASH + "{plantCode}";
	public static final String FINISH_PRODUCT_SAMPLES_BY_PLANT_CODE = FINISH_PRODUCT_SAMPLES + SLASH + "plant" + SLASH
			+ "{plantCode}";
	public static final String FINISH_PRODUCT_SAMPLE_BY_STATUS = FINISH_PRODUCT_SAMPLE + SLASH + "status" + SLASH
			+ "{status}";
	public static final String GET_FINISH_PRODUCT_BY_MATERIAL_CATEGORY = FINISH_PRODUCT_SAMPLES + SLASH
			+ "material-category" + SLASH + "{materialCategoryId}";
	public static final String RAW_FINISH_PRODUCT_SAMPLES_BY_MATERIAL_SUBCATORY_AND_PLANT = FINISH_PRODUCT_SAMPLE
			+ SLASH + "material-sub-category" + SLASH + "{materialSubCategoryId}" + PLANT_WISE;
	public static final String RAW_FINISH_PRODUCT_SAMPLES_BY_MATERIAL_CATORY_AND_PLANT = FINISH_PRODUCT_SAMPLE + SLASH
			+ "material-category" + SLASH + "{materialCategoryId}" + PLANT_WISE;
	public static final String RAW_FINISH_PRODUCT_SAMPLES_BY_RAW_MATERIAL_AND_PLANT = FINISH_PRODUCT_SAMPLE + SLASH
			+ "material" + SLASH + "{rawMaterialId}" + PLANT_WISE;
	public static final String FINISH_PRODUCT_SAMPLE_LIST = BASE_API_PATH + "finish-product-sample-list";
	...
	public static final String FINISH_PRODUCT_SAMPLE_ISSUE_SEARCH = FINISH_PRODUCT_SAMPLE_ISSUE + SEARCH + SLASH
			+ "{plantCode}";
	public static final String FINISH_PRODUCT_SAMPLE_ISSUES_BY_PLANT_CODE = FINISH_PRODUCT_SAMPLE_ISSUES + SLASH
			+ "plant" + SLASH + "{plantCode}";
	public static final String FINISH_PRODUCT_SAMPLE_ISSUES_BY_PLANT = FINISH_PRODUCT_SAMPLE_ISSUE + PLANT_WISE;
	...
	public static final String MATERIAL_SAMPLE_COUNT_BY_MATERIAL_CATEGORY = INCOMING_SAMPLES_COUNT_BY_MATERIAL + SLASH
			+ "{materialCategoryName}" + SLASH + "{plantCode}";
	...
	public static final String MATERIAL_SAMPLE_COUNT_BY_MATERIAL_SUB_CATEGORY = INCOMING_SAMPLES_COUNT_BY_MATERIAL
			+ SLASH + SUB_CATEGORY + SLASH + "{materialSubCategoryName}" + SLASH + "{plantCode}";
	...
	public static final String MATERIAL_CATEGORY_STATUS_COUNT = INCOMING_SAMPLES_COUNT + SLASH + "material-category"
			+ SLASH + "{materialCategoryName}" + SLASH + "{plantCode}";
	...
	public static final String MATERIAL_ACCEPTED_VALUES_PAGINATION = BASE_API_PATH + "material-accepted-values-pages"
			+ SLASH + "test-configure" + SLASH + "{testConfigureId}" + SLASH + "category-type" + SLASH
			+ "{categoryAcceptedType}";
	public static final String MATERIAL_ACCEPTED_VALUE_BY_ID = MATERIAL_ACCEPTED_VALUE + ID;
	public static final String MATERIAL_ACCEPTED_VALUE_BY_TEST_CONFIGURE_ID = MATERIAL_ACCEPTED_VALUE + "/dto"
			+ "/test-configure" + "/{testConfigureId}";
	public static final String MATERIAL_ACCEPTED_VALUE_DTO_BY_TEST_CONFIGURE_ID = MATERIAL_ACCEPTED_VALUE
			+ "/test-configure" + "/{testConfigureId}";
	public static final String MATERIAL_ACCEPTED_VALUE_BY_RAW_MATERIAL = MATERIAL_ACCEPTED_VALUE
			+ "/test-configure-by-raw-material" + "/{testConfigureId}";
	public static final String MATERIAL_SUB_CATEGORIES_BY_TEST_CONFIGURE_ID = MATERIAL_ACCEPTED_VALUE + SLASH
			+ "material-sub-categories" + SLASH + "test-configure" + SLASH + "{testConfigureId}";
	public static final String RAW_MATERIALS_BY_TEST_CONFIGURE_ID = MATERIAL_ACCEPTED_VALUE + SLASH + "raw-materials"
			+ SLASH + "test-configure" + SLASH + "{testConfigureId}";
	public static final String RAW_MATERIALS_BY_TEST_CONFIGURE_ID_AND_TEST_PARAMETERS = MATERIAL_ACCEPTED_VALUE + SLASH
			+ "raw-materials" + SLASH + "test-configure" + SLASH + "{testConfigureId}" + SLASH + "test-parameter"
			+ SLASH + "{testParameterId}";
	public static final String MATERIAL_SUB_CATEGORIES_BY_TEST_CONFIGURE_ID_AND_TEST_PARAMETERS = MATERIAL_ACCEPTED_VALUE
			+ SLASH + "material-sub-categories" + SLASH + "test-configure" + SLASH + "{testConfigureId}" + SLASH
			+ "test-parameter" + SLASH + "{testParameterId}";
	public static final String SEARCH_MATERIAL_ACCEPTED_VALUE = MATERIAL_ACCEPTED_VALUE + SLASH + "test-configure"
			+ SLASH + "{testConfigId}" + SLASH + "category-type" + SLASH + "{categoryAcceptedType}" + SEARCH;
	/*
	 * AcceptedValue
	 */
	...
	public static final String ACCEPTED_VALUES_PAGINATION = BASE_API_PATH + "accepted-values-page" + SLASH
			+ "test-configure" + SLASH + "{testConfigureId}";;
	public static final String ACCEPTED_VALUE_BY_ID = ACCEPTED_VALUE + ID;
	public static final String GET_ACCEPTED_VALUE_BY_TEST_CONFIGURE_ID = ACCEPTED_VALUE + SLASH + "dto" + SLASH
			+ "test-configure" + SLASH + "{testConfigureId}";
	public static final String SEARCH_ACCEPTED_VALUE = ACCEPTED_VALUE + SLASH + "test-configure" + SLASH
			+ "{testConfigId}" + SEARCH;
	public static final String GET_ACCEPTED_VALUE_DTO_BY_TEST_CONFIGURE_ID = ACCEPTED_VALUE + SLASH + "test-configure"
	...
	public static final String MATERIAL_TEST_REPORT_DETAIL = TEST_REPORT_DETAIL + SLASH + MATERIAL_TEST_CODE + SLASH
			+ "plant" + SLASH + "{plantCode}";
	/*
	 * test Report
	 */
	...
	public static final String FINISH_PRODUCT_TEST_DETAIL_REPORT = TEST_REPORT + SLASH + "finish-product-test" + SLASH
	...
	public static final String INCOMING_SAMPLE_SUMMARY_REPORT = BASE_API_PATH + "incoming-sample-summary-report" + SLASH
			+ "{incomingSampleCode}" + SLASH + "plant" + SLASH + "{plantCode}";
	public static final String INCOMING_SAMPLE_DELIVERY_REPORT = BASE_API_PATH + "incoming-sample-delivery-report"
			+ SLASH + "{incomingSampleCode}" + SLASH + "{reportFormat}" + SLASH + "plant" + SLASH + "{plantCode}";
	...
	public static final String MATERIAL_TEST_TRIALS_WISE_BY_MATERIAL_TEST_CODE = BASE_API_PATH
			+ "material-test-trials-wise" + SLASH + "{materialTestCode}";
	public static final String CONCRETE_STRENGTHS_BY_PLANT = BASE_API_PATH + "concrete-strengths" + SLASH + "plant"
			+ SLASH + "{plantCode}";
	public static final String SIEVE_TRIALS_BY_MATERIAL_TEST_CODE_PLANT_CODE = BASE_API_PATH + "material-test-sieve"
			+ SLASH + "{materialTestCode}" + SLASH + "plant" + SLASH + "{plantCode}";
	public static final String SIEVE_TEST_GRAPH_BY_MATERIAL_TEST_CODE = BASE_API_PATH + "material-test-graph" + SLASH
			+ "{materialTestCode}";
	/*
	 * File Export
	 */
	...
	public static final String PARAMETER_EQUATION_BY_TEST_PARAMETER_ID = PARAMETER_EQUATION + SLASH + "test-parameter"
			+ SLASH + "{testParameterId}";
	public static final String PARAMETER_EQUATION_BY_TEST_CONFIGURE_ID = PARAMETER_EQUATION + SLASH + "test-configure"
			+ SLASH + "{testConfigureId}";

	/*
	 * Parameter Equation Element apis
	 */
	public static final String PARAMETER_EQUATION_ELEMENT = BASE_API_PATH + "parameter-equation-element";
	...
	public static final String PARAMETER_EQUATION_ELEMENTS = BASE_API_PATH + "parameter-equation-elements";
	public static final String PARAMETER_EQUATION_ELEMENT_BY_TEST_PARAMETER_ID = PARAMETER_EQUATION_ELEMENT + SLASH
			+ "test-parameter" + SLASH + "{testParameterId}";
	public static final String PARAMETER_EQUATION_ELEMENT_BY_PARAMETER_EQUATION_ID = PARAMETER_EQUATION_ELEMENT + SLASH
			+ "parameter-equation" + SLASH + "{parameterEquationId}";
	public static final String PARAMETER_EQUATION_ELEMENT_BY_TEST_PARAMETER = PARAMETER_EQUATION_ELEMENT + SLASH
			+ "parameter-equation" + SLASH + "test-parameter" + SLASH + "{testParameterId}";
	/*
	...
	public static final String FINISH_PRODUCT_TRIALS_BY_FINISH_PRODUCT_TEST_CODE = FINISH_PRODUCT_TRIALS + SLASH
			+ "finish-product-test" + SLASH + "{finishProductTestCode}";
	public static final String FINISH_PRODUCT_TEST_STATUS_BY_FINISH_PRODUCT_TEST_CODE = FINISH_PRODUCT_TRIAL + SLASH
			+ "finish-product-test-status" + SLASH + "{finishProductTestCode}";
	...
	public static final String FINISH_PRODUCT_PARAMETER_RESULT = BASE_API_PATH + "finish-product-parameter-result";
	public static final String FINISH_PRODUCT_PARAMETER_RESULT_BY_FINISH_PRODUCT_TEST_CODE = FINISH_PRODUCT_PARAMETER_RESULT
			+ SLASH + "finish-product-test-result" + SLASH + "{finishProductTestCode}";
	public static final String FINISH_PRODUCT_RESULT_BY_FINISH_PRODUCT_CODE = FINISH_PRODUCT_TRIAL + SLASH
			+ "finish-product-test" + SLASH + "{finishProductCode}";
	/*
	 * Finish Product Test
	 */
	...
	public static final String GET_FINISH_PRODUCT_TESTS_BY_TESTCONFIGURE = FINISH_PRODUCT_TESTS + SLASH
			+ "test-configure" + SLASH + "{testConfigureId}";
	public static final String GET_FINISH_PRODUCT_TESTS_BY_FINISH_PRODUCT_SAMPLE_TESTCONFIGURE = FINISH_PRODUCT_TESTS
			+ SLASH + "finish-product-sample" + SLASH + "{finishProductSampleCode}" + SLASH + "test-configure" + SLASH
			+ "{testConfigureId}";
	...
	public static final String GET_FINISH_PRODUCT_TESTS_BY_FINISH_PRODUCT_SAMPLE = FINISH_PRODUCT_TEST + SLASH
			+ "finish-product-sample" + SLASH + "{finishProductSampleCode}";
	public static final String FINISH_PRODUCT_TEST_SEARCH = FINISH_PRODUCT_TEST + SEARCH + SLASH + "{plantCode}";
	public static final String GET_FINISH_PRODUCT_TESTS_BY_FINISH_PRODUCT_SAMPLE_CODE = FINISH_PRODUCT_TESTS + SLASH
			+ "finish-product-sample" + SLASH + "{finishProductSampleCode}";
	...
	public static final String EMAIL_RECIPIENTS_BY_RECIPIENT_TYPE = EMAIL_RECIPIENT + SLASH + "{emailGroupId}" + SLASH
			+ "recipientType" + SLASH + "{recipientType}";
	...
	public static final String EMAIL_GROUP_BY_SHEDULE = EMAIL_GROUPS + SLASH + "email-group-schedule" + SLASH
			+ "{schedule}";
	public static final String EMAIL_GROUP_BY_PLANT_CODE = EMAIL_GROUPS + SLASH + "email-group-plant-code" + SLASH
			+ "{plantCode}";
	public static final String EMAIL_GROUP_BY_PLANT_CODE_AND_STATUS = EMAIL_GROUPS + SLASH + "plant-code" + SLASH
			+ "{plantCode}" + SLASH + "status" + SLASH + "{status}";
	public static final String EMAIL_GROUP_BY_PLANT_CODE_AND_STATUS_SCEHDULE = EMAIL_GROUPS + SLASH + "plant-code"
			+ SLASH + "{plantCode}" + SLASH + "status" + SLASH + "{status}" + SLASH + "schedule" + SLASH + "{schedule}";
	public static final String EMAIL_GROUP_BY_PLANT_CODE_ADMIN_STATUS = EMAIL_GROUPS + SLASH
			+ "email-group-admin-status" + SLASH + "plant-code" + SLASH + "{plantCode}" + SLASH + "admin-status" + SLASH
			+ "{adminStatus}";
	public static final String EMAIL_GROUP_BY_ADMIN_STATUS = EMAIL_GROUPS + SLASH + "email-group-admin-status" + SLASH
			+ "{adminStatus}";
	...
	public static final String TEST_EQUATION_BY_TEST_CONFIGURE_ID = TEST_EQUATION + SLASH + "test-configure" + SLASH
			+ "{testConfigureId}";
	public static final String TEST_EQUATION_BY_EQUATION_ID = TEST_EQUATION + SLASH + "equation" + SLASH
			+ "{equationId}";
	public static final String TEST_EQUATION_BY_TEST_PARAMETER_ID = TEST_EQUATION + SLASH + "test-parameter" + SLASH
			+ "{testParameterId}";
	/*
	...
	public static final String TEST_EQUATION_PARAMETER_BY_TEST_PARAMETER_ID = TEST_EQUATION_PARAMETER + SLASH
			+ "test-parameter" + SLASH + "{testParameterId}";
	public static final String TEST_EQUATION_PARAMETER_BY_TEST_EQUATION_ID = TEST_EQUATION_PARAMETER + SLASH
			+ "test-equation" + SLASH + "{testEquationId}";
	/*
	 * Email Points
	 */
	...
	public static final String EMAIL_POINTS_BY_ADMIN_STATUS = EMAIL_POINT + SLASH + "admin-status" + SLASH + "{status}";

	/*
	 * Finish Product Accepted Value
	 */
	public static final String FINISH_PRODUCT_ACCEPTED_VALUE = BASE_API_PATH + "finish-product-accepted-value";
	public static final String FINISH_PRODUCT_ACCEPTED_VALUES = BASE_API_PATH + "finish-product-accepted-values";
	public static final String FINISH_PRODUCT_ACCEPTED_VALUE_BY_ID = FINISH_PRODUCT_ACCEPTED_VALUE + ID;
	public static final String GET_FINISH_PRODUCT_ACCEPTED_VALUE_BY_TEST_PARAMETER = FINISH_PRODUCT_ACCEPTED_VALUE
			+ SLASH + "test-parameter" + SLASH + "{testParameterId}";

	public static final String GET_FINISH_PRODUCT_ACCEPTED_VALUE_BY_TEST_CONFIGURE = FINISH_PRODUCT_ACCEPTED_VALUE
			+ SLASH + "test-configure" + SLASH + "{testConfigureId}";
	/*
	 * Export & Import
	 */
	...
	public static final String EXPORT_RAW_MATERIAL = BASE_API_PATH + SLASH + "raw-material" + SLASH + "download";
	public static final String IMPORT_RAW_MATERIAL = BASE_API_PATH + SLASH + "raw-material" + SLASH + "upload";
	...
	public static final String CORE_TEST_CONFIGURE_BY_RAWMATERIAL_ID = CORE_TEST_CONFIGURE + SLASH + "raw-material"
			+ SLASH + "{rawMaterialId}";
	public static final String CORE_TEST_CONFIGURE_BY_TEST_CONFIGURE_ID = CORE_TEST_CONFIGURE + SLASH + "test-configure"
			+ SLASH + "{testConfigureId}";
	public static final String LIST_CORE_TEST_CONFIGURE_BY_TEST_CONFIGURE_ID = CORE_TEST_CONFIGURE + SLASH
			+ "test-configure-Id" + SLASH + "{testConfigureId}";
	public static final String LIST_ALL_CORE_TEST_CONFIGURE_BY_TEST_CONFIGURE_ID = CORE_TEST_CONFIGURE + SLASH + "test"
			+ SLASH + "{testId}";
	public static final String CORE_TEST_CONFIGURE_BY_MATERIAL_CATEGORY_ID = CORE_TEST_CONFIGURE + SLASH
			+ "mainCategory" + SLASH + "{mainCategoryId}";
	public static final String CORE_TEST_CONFIGURE_BY_MATERIAL_SUB_CATEGORY_ID = CORE_TEST_CONFIGURE + SLASH
			+ "materialSubCategory" + SLASH + "{materialSubCategoryId}";
	public static final String CORE_TEST_CONFIGURE_BY_RAW_MATERIAL_ID = CORE_TEST_CONFIGURE + SLASH + "rawMaterial"
			+ SLASH + "{rawMaterialId}";
	public static final String CORE_TEST_CONFIGURE_TEST_ORIGIN = CORE_TEST_CONFIGURE + SLASH + "test-origin";
	public static final String CORE_TEST_CONFIGURE_SEARCH = CORE_TEST_CONFIGURE + SLASH + "search" + SLASH
			+ "test-configure-Id" + SLASH + "{testConfigureId}";
	...
	public static final String STRENGTH_BY_FINISH_PRODUCT_TEST_CODE = BASE_API_PATH + "strength" + SLASH
			+ "{finishProductTestCode}" + SLASH + "plant" + SLASH + "{plantCode}";
	public static final String EXPORT_FINISHED_PRODUCT_DELIVERY = BASE_API_PATH + SLASH + "finished-product-delivery"
			+ SLASH + "download";
	public static final String IMPORT_FINISHED_PRODUCT_DELIVERY = BASE_API_PATH + SLASH + "finished-product-delivery"
			+ SLASH + "upload";
	public static final String GET_MATERIAL_TESTS_BY_INCOMING_SAMPLE = MATERIAL_TEST + SLASH + "incoming-sample" + SLASH
			+ "{incomingSampleCode}";
	...
	public static final String MIX_DESIGN_RATIO_CONFIG_MIXDESIGN_CODE = MIX_DESIGN_RATIO_CONFIG + SLASH + "mix-design"
			+ SLASH + "{mixDesignCode}";
	public static final String MIX_DESIGN_RATIO_CONFIG_UPDATE = MIX_DESIGN_RATIO_CONFIG + SLASH + "update" + SLASH
			+ "{mixDesignCode}";
	...
	public static final String RATIO_CONFIG_DETAILS_CONFIG_ID = RATIO_CONFIG + SLASH + "details" + SLASH
			+ "{ratioConfigId}";
	...
	public static final String RATIO_CONFIG_PARAMETER_BY_RATIO_CONFIG = RATIO_CONFIG_PARAMETER + SLASH + "ratio-config"
			+ SLASH + "{ratioConfigId}";
	public static final String RATIO_CONFIG_PARAMETER_BY_RATIO_CONFIGS = RATIO_CONFIG_PARAMETER + SLASH
			+ "ratio-configs" + SLASH + "{ratioConfigIds}";
	...
	public static final String RATIO_CONFIG_EQUATION_BY_RATIO_CONFIG = RATIO_CONFIG_EQUATION + SLASH + "ratio-config"
			+ SLASH + "{ratioConfigId}";
	...
	public static final String GET_TEST_IMAGES_BY_MATERIAL_TEST = UPLOAD_IMAGE + SLASH + "materialTest" + SLASH
			+ "{materialTestCode}";
	public static final String GET_TEST_IMAGES_BY_FINISHPRODUCT_TEST = UPLOAD_IMAGE + SLASH + "finishProductTest"
			+ SLASH + "{finishProductTestCode}";
	...
	public static final String GET_SAMPLES_BY_TYPE = RAW_MATERIAL_SAMPLE + "/sample-type" + "/{rawMaterialSampleType}";
	public static final String GET_ALL_SAMPLES_BY_TYPE = RAW_MATERIAL_SAMPLE + "/all-samples"
			+ "/{rawMaterialSampleType}";
	...
	public static final String MULTI_RESULT_FORMULA_BY_TEST_CONFIGURE_ID = BASE_API_PATH + "multi-result-formula"
			+ SLASH + "test-configure" + SLASH + "{testConfigureId}";
	public static final String MULTI_RESULT_PARAMETERS_BY_TEST_CONFIGURE_ID = BASE_API_PATH + "parameters" + SLASH
			+ "test-configure" + SLASH + "{testConfigureId}";
