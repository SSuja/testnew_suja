...
public final class EndpointURI {
	...
	public static final String MATERIAL_TESTS_BY_TESTCONFIGURE_TESTTYPE=MATERIAL_TESTS + "/test-configure" +"/testType"+ SLASH +"{testType}";
	public static final String MATERIAL_TESTS_BY_TESTCONFIGURE_TESTID=MATERIAL_TESTS + "/test-configure" +"/test"+ SLASH +"{testId}";
