...
public class ParameterController {
	...
	public ResponseEntity<Object> getParameterSearch(@QuerydslPredicate(root = Parameter.class) Predicate predicate,
			@RequestParam(name = "page") int page, @RequestParam(name = "size") int size) {
		return new ResponseEntity<>(new ContentResponse<>(Constants.PARAMETERS,
				parameterService.searchParameter(predicate, page, size), RestApiResponseStatus.OK), null,
				HttpStatus.OK);
	}
