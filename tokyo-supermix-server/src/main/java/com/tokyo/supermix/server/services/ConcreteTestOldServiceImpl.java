...
import com.tokyo.supermix.data.repositories.ConcreteTestOldRepository;
import com.tokyo.supermix.data.repositories.MixDesignProportionRepository;
import com.tokyo.supermix.util.Constants;

@Service
public class ConcreteTestOldServiceImpl implements ConcreteTestOldService {
  @Autowired
  private ConcreteTestOldRepository concreteTestRepository;
  @Autowired
