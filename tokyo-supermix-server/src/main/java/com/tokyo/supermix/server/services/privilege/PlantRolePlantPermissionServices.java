...
public interface PlantRolePlantPermissionServices {
  ...
  public List<PlantRolePlantPermissionRequestDto> getRolePlantPermissionsByPlantRoleIdAndSubModuleID(Long plantRoleId ,Long subModuleId);
  
  public List<PlantRolePlantPermissionRequestDto> getByPlantRoleIdAndStatus(Long plantRoleId , Boolean status);
