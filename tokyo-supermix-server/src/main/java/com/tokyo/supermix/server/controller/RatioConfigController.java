...
public class RatioConfigController {
	...
	public ResponseEntity<Object> deleteRatioConfig(@PathVariable Long id) {
		if (ratioConfigService.isRatioConfigExist(id)) {
			...
			return new ResponseEntity<>(new BasicResponse<>(RestApiResponseStatus.OK, Constants.RATIO_CONFIG_DELETED),
					HttpStatus.OK);
		}
		logger.debug("Invalid Id");
		return new ResponseEntity<>(new ValidationFailureResponse(Constants.RATIO_CONFIG,
	...
	public ResponseEntity<Object> createRatioConfig(@Valid @RequestBody RatioConfigRequestDto ratioConfigRequestDto) {
	...
	public ResponseEntity<Object> updateDesignation(@Valid @RequestBody RatioConfigRequestDto ratioConfigRequestDto) {
