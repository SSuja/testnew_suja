...
public class MacAddressController {
  ...
  public ResponseEntity<Object> createMacAddress(@Valid @RequestBody MacAddressDto macAddressDto) {
    ...
    return new ResponseEntity<>(
        new BasicResponse<>(RestApiResponseStatus.OK, Constants.ADD_MAC_ADDRESS_SUCCESS),
        HttpStatus.OK);
  }
  ...
  public ResponseEntity<Object> getAllMacAddress() {
    return new ResponseEntity<>(new ContentResponse<>(Constants.MAC_ADDRESS,
        mapper.map(macAddressService.getAllMacAddress(), MacAddressDto.class),
  ...
  public ResponseEntity<Object> deleteMacAddress(@PathVariable Long id) {
    if (macAddressService.isMacAddressExist(id)) {
      ...
      return new ResponseEntity<>(
          new BasicResponse<>(RestApiResponseStatus.OK, Constants.MAC_ADDRESS_DELETED),
          HttpStatus.OK);
    }
    return new ResponseEntity<>(new ValidationFailureResponse(Constants.MAC_ADDRESS,
  ...
  public ResponseEntity<Object> getMacAddressById(@PathVariable Long id) {
    if (macAddressService.isMacAddressExist(id)) {
      return new ResponseEntity<>(new ContentResponse<>(Constants.MAC_ADDRESS,
          mapper.map(macAddressService.getMacAddressById(id), MacAddressDto.class),
