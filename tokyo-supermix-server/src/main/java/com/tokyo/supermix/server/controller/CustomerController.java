...
public class CustomerController {
	...
	public ResponseEntity<Object> getAllCustomers() {
		...
		List<CustomerDto> customerDtoList = mapper.map(customerList, CustomerDto.class);
	  ...
	  public ResponseEntity<Object> getCustomerById(@PathVariable Long id) {
	    if (customerService.isCustomerExist(id)) {
	      ...
	      return new ResponseEntity<>(new ContentResponse<>(Constants.CUSTOMER,
	          mapper.map(customer,CustomerDto.class), RestApiResponseStatus.OK),
	          HttpStatus.OK);
	    }
	...
	// Update Customer
	  @PutMapping(value = EndpointURI.UPDATE_CUSTOMER)
