...
public class CoreTestConfigureController {
	...
	public ResponseEntity<Object> createCoreTestConfigure(
		...
		coreTestConfigureService.saveCoreTestConfigure(mapper.map(coreTestConfigureDtoList, CoreTestConfigure.class));
	...
	public ResponseEntity<Object> getCoreTestConfigureByTestConfigureId(@PathVariable Long testConfigureId) {
		return new ResponseEntity<>(new ContentResponse<>(Constants.CORE_TEST_CONFIGURES,
	...
	public ResponseEntity<Object> getTest() {
		...
		return new ResponseEntity<>(
				new BasicResponse<>(RestApiResponseStatus.OK, Constants.ADD_MATERIAL_ACCEPTED_VALUE_SUCCESS),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getCoreTestConfigureListByTestConfigureId(@PathVariable Long testConfigureId) {
		return new ResponseEntity<>(new ContentResponse<>(Constants.CORE_TEST_CONFIGURES,
	...
	public ResponseEntity<Object> getCoreTestConfigureListByMainCatId(@PathVariable Long mainCategoryId) {
		return new ResponseEntity<>(new ContentResponse<>(Constants.CORE_TEST_CONFIGURES,
	...
	public ResponseEntity<Object> getCoreTestConfigureListByRawMaterialId(@PathVariable Long rawMaterialId) {
		return new ResponseEntity<>(new ContentResponse<>(Constants.CORE_TEST_CONFIGURES,
	...
	public ResponseEntity<Object> getRawMaterialSearch(@PathVariable Long testConfigureId,
		...
		return new ResponseEntity<>(
				new PaginatedContentResponse<>(
						Constants.CORE_TEST_CONFIGURES, coreTestConfigureService.searchRawMaterial(booleanBuilder,
								testConfigureId, rawMaterialName, materialSubCategoryId),
