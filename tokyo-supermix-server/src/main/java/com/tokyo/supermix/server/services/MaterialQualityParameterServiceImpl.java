...
public class MaterialQualityParameterServiceImpl implements MaterialQualityParameterService {
	...
	@Override
	public boolean isDuplicateRowExists(Long qualityParameterId, Long rawMaterialId, Double value, Long unitId) {
		if (materialQualityParameterRepository.existsByQualityParameterIdAndRawMaterialIdAndValueAndUnitId(qualityParameterId, rawMaterialId, value,  unitId)) {
			return true;
		}
		return false;
	}
