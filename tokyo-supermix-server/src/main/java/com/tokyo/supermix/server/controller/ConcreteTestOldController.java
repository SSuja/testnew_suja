...
import com.tokyo.supermix.server.services.ConcreteTestOldService;
...
@CrossOrigin(origins = "*")
@RestController
public class ConcreteTestOldController {
  @Autowired
  ...
  @Autowired
  private ConcreteTestOldService concreteTestService;
  @Autowired
