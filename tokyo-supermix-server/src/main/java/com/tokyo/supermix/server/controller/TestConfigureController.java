...
public class TestConfigureController {
	...
	public ResponseEntity<Object> createTestConfigure(
		...
		if (testConfigureService.isExistByTestIdAndMaterialSubCategoryId(testConfigureRequestDto.getTestId(),
	...
	public ResponseEntity<Object> updateTestConfigure(
		...
		if (testConfigureService.isTestConfigureExist(testConfigureRequestDto.getId())) {
			...
			testConfigureService.updateTestConfigure(mapper.map(testConfigureRequestDto, TestConfigure.class));
			return new ResponseEntity<>(
	...
	public ResponseEntity<Object> getTestConfigureByMaterialSubCategory(@PathVariable Long materialSubCategoryId) {
	...
	@PutMapping(value =EndpointURI.UPDATE_ACCEPTED_TYPE_TEST_CONFIGURE)
  public ResponseEntity<Object> updateAcceptedTypeTestConfigure(@PathVariable Long testConfigureId,@PathVariable AcceptedType acceptedType) {
    	...
    	testConfigureService.saveTestConfigure(mapper.map(testConfigure, TestConfigureRequestDto.class));
      return new ResponseEntity<>(
          new BasicResponse<>(RestApiResponseStatus.OK, Constants.UPDATE_TEST_CONFIGURE_SUCCESS),
          HttpStatus.OK);
      }
