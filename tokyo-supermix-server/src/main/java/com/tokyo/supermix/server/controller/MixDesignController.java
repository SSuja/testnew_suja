...
public class MixDesignController {
	...
	public ResponseEntity<Object> getAllMixDesigns() {
		return new ResponseEntity<>(new ContentResponse<>(Constants.MIX_DESIGNS,
				mapper.map(mixDesignService.getAllMixDesigns(), MixDesignResponseDto.class), RestApiResponseStatus.OK),
				null, HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> deleteMixDesign(@PathVariable String code) {
		if (mixDesignService.isCodeExist(code)) {
			...
			return new ResponseEntity<Object>(
					new BasicResponse<>(RestApiResponseStatus.OK, Constants.MIX_DESIGN_DELETED), HttpStatus.OK);
		}
	...
	public ResponseEntity<Object> updateMixDesign(@Valid @RequestBody MixDesignRequestDto mixDesignRequestDto) {
		if (mixDesignService.isCodeExist(mixDesignRequestDto.getCode())) {
			...
			return new ResponseEntity<Object>(
					new BasicResponse<>(RestApiResponseStatus.OK, Constants.UPDATE_MIX_DESIGN_SUCCESS), HttpStatus.OK);
		}
	...
	public ResponseEntity<Object> getMixDesignsBySearch(@RequestParam(name = "page") int page,
			@RequestParam(name = "size") int size, @RequestParam(name = "code", required = false) String code,
