...
public class FinishProductTrialServiceImpl implements FinishProductTrialService {
	...
	public void updateFinishProductResult(FinishProductTrial finishProductTrial) {
		...
		if (finishProductTrial.getTestParameter() != null) {
			...
			if (check) {
				finishProductParameterResult.setResult(roundDoubleValue(averageResult(finishProductTest.getCode())));
			...
			if (check) {
				finishProductTest.setResult(roundDoubleValue(strengthGradeRatio(finishProductTrial.getValue(),
						finishProductSample.getMixDesign().getCode())));
				finishProductTestRepository.save(finishProductTest);

			} else {
				finishProductTest.setResult(roundDoubleValue(
						slumpGradeRatio(finishProductTrial.getValue(), finishProductSample.getMixDesign().getCode())));
				finishProductTestRepository.save(finishProductTest);
