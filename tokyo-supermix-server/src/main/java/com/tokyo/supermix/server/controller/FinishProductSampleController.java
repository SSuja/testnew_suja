...
public class FinishProductSampleController {
  ...
  public ResponseEntity<Object> getAllFinishProductSamplesByPlant(
    ...
    if (plantCode.equalsIgnoreCase(Constants.ADMIN)) {
      pagination.setTotalRecords(finishProductSampleService
          .getCountFinishProductSampleByType(FinishProductSampleType.LAB_TRIAL_SAMPLE));
      return new ResponseEntity<>(
          new PaginatedContentResponse<>(Constants.FINISH_PRODUCT_SAMPLES,
              mapper.map(
                  finishProductSampleService.getAllFinishProductSamplesByPlant(
                      FinishProductSampleType.LAB_TRIAL_SAMPLE, currentUser, pageable),
                  FinishProductSampleResponseDto.class),
    ...
    if (currentUserPermissionPlantService.getPermissionPlantCodeByCurrentUser(currentUser,
      ...
      pagination.setTotalRecords(
          finishProductSampleService.getCountFinishProductSampleTypeByPlantCode(plantCode,
              FinishProductSampleType.LAB_TRIAL_SAMPLE));
      return new ResponseEntity<>(
          new PaginatedContentResponse<>(Constants.FINISH_PRODUCT_SAMPLES,
              mapper.map(
                  finishProductSampleService.getFinishProductSampleByPlantCode(
                      FinishProductSampleType.LAB_TRIAL_SAMPLE, plantCode, pageable),
                  FinishProductSampleResponseDto.class),
              RestApiResponseStatus.OK, pagination),
          HttpStatus.OK);
    }
  ...
  public ResponseEntity<Object> getFinishProductSearch(@PathVariable String plantCode,
    ...
    return new ResponseEntity<>(new PaginatedContentResponse<>(Constants.FINISH_PRODUCT_SAMPLES,
        finishProductSampleService.searchFinishProductSample(booleanBuilder, finishProductCode,
            ...
            workOrderNumber, customer, FinishProductSampleType.LAB_TRIAL_SAMPLE, pageable,
            pagination),
  ...
  public ResponseEntity<Object> getFinishProductSearch(@PathVariable String plantCode,
    ...
    return new ResponseEntity<>(new PaginatedContentResponse<>(Constants.FINISH_PRODUCT_SAMPLES,
        finishProductSampleService.searchFinishProductSample(booleanBuilder, finishProductCode,
            equipmentName, mixDesignCode, plantName, plantCode, status, date, code, rawMaterialName,
            workOrderNumber, customer, FinishProductSampleType.DELIVERY_SAMPLE, pageable,
            pagination),
        RestApiResponseStatus.OK, pagination), null, HttpStatus.OK);
  }
  ...
  public ResponseEntity<Object> getAllFinishProductSampleIssuesByPlant(
    ...
    if (plantCode.equalsIgnoreCase(Constants.ADMIN)) {
      pagination.setTotalRecords(finishProductSampleService
          .getCountFinishProductSampleByType(FinishProductSampleType.DELIVERY_SAMPLE));
      return new ResponseEntity<>(
          new PaginatedContentResponse<>(Constants.FINISH_PRODUCT_SAMPLES,
              mapper.map(
                  finishProductSampleService.getAllFinishProductSamplesByPlant(
                      FinishProductSampleType.DELIVERY_SAMPLE, currentUser, pageable),
                  FinishProductSampleResponseDto.class),
              RestApiResponseStatus.OK, pagination),
          HttpStatus.OK);
    }
    if (currentUserPermissionPlantService.getPermissionPlantCodeByCurrentUser(currentUser,
      ...
      return new ResponseEntity<>(
          new PaginatedContentResponse<>(Constants.FINISH_PRODUCT_SAMPLES,
              mapper.map(
                  finishProductSampleService.getFinishProductSampleByPlantCode(
                      FinishProductSampleType.DELIVERY_SAMPLE, plantCode, pageable),
                  FinishProductSampleResponseDto.class),
              RestApiResponseStatus.OK, pagination),
          HttpStatus.OK);
    }
