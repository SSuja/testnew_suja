...
public class FinishProductDeliveryLayouter {
  ...
  public static void buildTitle(HSSFSheet worksheet, int startRowIndex, int startColIndex) {
    ...
    cellTitle.setCellValue("Finished Product Delivery Details");
  ...
  public static void buildHeaders(HSSFSheet worksheet, int startRowIndex, int startColIndex) {
    ...
    cell2.setCellValue("MixDesign Code");
    cell2.setCellStyle(headerCellStyle);
    
    HSSFCell cell3 = rowHeader.createCell(startColIndex + 2);
    cell3.setCellValue("Plant Equipment");
    ...
    cell5.setCellValue("Sample Code");
    cell5.setCellStyle(headerCellStyle);

    HSSFCell cell6 = rowHeader.createCell(startColIndex + 5);
    cell6.setCellValue("Work Order No");
