...
INSERT INTO `tokyo-supermix`.`role` (`id`, `role_name`) VALUES ('2', 'USER');
--create User 
...
--admin pwd --
INSERT INTO `tokyo-supermix`.`user` (`id`, `email`, `password`, `user_name`, `role_id`, `created_at`, `updated_at`) VALUES ('2', 'user@gmail.com', '$2y$10$WYI8/0dTM5y.0VZKCEbFWuU1Y39zOx6V3oFj6EZvh6AGXp0T.VQVK', 'user', '2', '2020-05-06 16:58:02', '2020-05-06 21:28:58');
--admin pwd --